...
class DFLossHistoryPage:
    ...
    def fill_loss_history(self, params: DFLossHistoryParams):
        ...
        self.open_claims_select.select_option(params.AnyOpenClaims)
        self.check_loading()
        self.has_loss_select.select_option(params.AnyLossesInPast5Years)
        self.check_loading()
        self.unrepaired_select.select_option(params.UnrepairedDamagefromPriorLosses)
        self.check_loading()
        ...
        for i, loss in enumerate(params.losses):
            ...
            self.loss_date_input(i).fill(loss.LossDate)
            self.loss_type_select(i).select_option(loss.TypeOfLoss)
