...
class PrintYourQuotePage:
    ...
    def save_premium(self, data):
        ...
        write_excel_cell("src/data/output/wh_output.xlsx", "Output", row_value=data["01_Policy_Info"][0]["Test ID"], column_name="Quote Number", data=quote_number)
        write_excel_cell("src/data/output/wh_output.xlsx", "Output", row_value=data["01_Policy_Info"][0]["Test ID"], column_name="Total Premium", data=total_premium)
        write_excel_cell("src/data/output/wh_output.xlsx", "Output", row_value=data["01_Policy_Info"][0]["Test ID"], column_name="Total Fee", data=total_fee)
        write_excel_cell("src/data/output/wh_output.xlsx", "Output", row_value=data["01_Policy_Info"][0]["Test ID"], column_name="Total Tax", data=total_tax)
        write_excel_cell("src/data/output/wh_output.xlsx", "Output", row_value=data["01_Policy_Info"][0]["Test ID"], column_name="Grand Total", data=grand_total)
