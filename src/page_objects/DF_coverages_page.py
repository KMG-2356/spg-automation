...
class DFCoveragesPage:
    ...
    def fill_DFcoverages_info(self, params: DFcoverageParams):
        ...
        self.CoverageELLimitofLiability_select.select_option(params.CoverageELLimitofLiability)
        self.check_loading()
        self.LossofRentsCoverageD_select.select_option(params.LossofRentsCoverageD)
        self.check_loading()
        self.OwnersContentsCoverageC_select.select_option(params.OwnersContentsCoverageC)
        self.check_loading()         
        self.OwnersContentsBurglaryCoverage_select.select_option(params.OwnersContentsBurglaryCoverage)
        self.check_loading()
        self.HomeSystemsProtection_select.select_option(params.HomeSystemsProtection)
        self.check_loading()            
        self.ServiceLineCoverage_select_select.select_option(params.ServiceLineCoverage)
        self.check_loading()
        self.IdentityTheftCoverage_select.select_option(params.IdentityTheftCoverage)
        self.check_loading()
