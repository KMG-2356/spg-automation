...
class APDInsuredInformationPage:
    def __init__(self, page: Page):
        ...
        self.trustee_street2_input = self.page.locator("div:nth-child(2) > .jss94 > .jss97 > div:nth-child(2) > .MuiInputBase-root > .MuiInputBase-input")
        self.trustee_city_input = self.page.locator("div:nth-child(2) > .jss94 > .jss97 > .MuiFormControl-root.MuiTextField-root.jss102 > .MuiInputBase-root > .MuiInputBase-input")
        self.trustee_state_select = self.page.get_by_role("combobox").nth(2)
        self.trustee_zip_input = self.page.locator("div:nth-child(2) > .jss94 > .jss97 > .MuiFormControl-root.MuiTextField-root.jss104 > .MuiInputBase-root > .MuiInputBase-input")
    ...
    def fill_apd_insured_information_form(self, params: APDInsuredInfoParams):
        ...
        # Note: Add another garaging address button is defined in your page object here if needed:
