...
FEATURE_PATH = os.path.join(os.path.dirname(__file__), "..", "property_gl_tria_combined.feature")
...
def when_user_generates_premium(page, test_data):
    ...
    commercial_line_basic_info_page.fill_commercial_line_basic_information_Prop_GL_tria_form(test_data)
