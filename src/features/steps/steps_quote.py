...
from page_objects import quote_page
import pytest
...
def given_home_page_open(home_page, base_url):
    home_page.navigate(base_url)
    return home_page


@when('the user generates a premium')
def when_user_generates_premium(home_page, page):
...
def then_generated_premium_should_be_equal(quote_page):
    pass