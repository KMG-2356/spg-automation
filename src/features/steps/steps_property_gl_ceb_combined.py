...
FEATURE_PATH = os.path.join(os.path.dirname(__file__), "..", "property_gl_ceb_combined.feature")
...
def when_user_generates_premium(page, test_data):
    ...
    commercial_line_basic_info_page.fill_commercial_line_basic_information_Prop_GL_ceb_form(test_data)
...
def then_generated_premium_should_be_equal(page, test_data):
    ...
    print_your_quote_page.save_premium(test_data, "cp_gl_ceb_output","Policy_Info")
