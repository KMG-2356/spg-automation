Feature: Commercial Lines Auto Physical Damage and Terrorism (APD + TRIA) Premium verification againts excel rater 
  In order to verify the generated a premium
  in Commercial Lines LOB and save it in the excel sheet

  Scenario: Save the premium for APD TRIA Combined LOB
